    ...
    >
      ...
      `}>
        <div className="content text-center text-raisin-black bg-white pt-4 pb-6 rounded-[30px]">
          <div className="px-4">
            <Button variant="secondary black" suffixIcon="close" className="ml-auto" onClick={() => toggleModal(false)}/>
          </div>

          <div className="grid justify-items-center px-6 border-b border-very-light-azure pb-8">
            <img src="/assets/modal/party-popper.png" alt="Thank You!" className="w-15"/>

            <h6 className="font-bold mt-8">Thanks for signing up to waitlist!</h6>
          </div>
